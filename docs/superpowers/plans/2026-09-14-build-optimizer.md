...
- [ ] Step 1 寫失敗測試 → Step 2 確認紅 → Step 3 實作 mapping 與 fixture 腳本 → Step 4 重建 fixture（`uv run python scripts/build_fixtures.py`），**全套件既有斷言不變** → Step 5 提交
...
- [ ] 同五步驟＋offscreen 冒煙＋實際開 app 目視一次
