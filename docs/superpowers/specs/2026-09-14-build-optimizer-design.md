...
**2026-09-15 更新（英雄技能上線，`2026-09-15-champion-kits-design.md`）** ——
上兩表皆已被取代。含被動＋技能、熟練玩家假設（16.15.1 fixture）：

```
達瑞文 vs 脆皮：雲陶狂箭 3032 → 狂戰士護脛 3006 → 臨界點 3302 → 蒐集者 6676
                → 破堡者 2520 → 無盡之刃 3031
達瑞文 vs 坦克：雲陶狂箭 3032 → 狂戰士護脛 3006 → 多明尼克 3036 → 破敗 3153
                → 鬼索 3124 → 無盡之刃 3031
凱爾   vs 脆皮：鬼索 3124 → 狂戰士護脛 3006 → 海妖 6672 → 臨界點 3302
                → 雲陶狂箭 3032 → 無盡之刃 3031
煞蜜拉 vs 脆皮：雲陶狂箭 3032 → 狂戰士護脛 3006 → 無盡之刃 3031 → 蒐集者 6676
                → 多明尼克 3036 → 破堡者 2520
```

- **三隻推薦彼此不同**（測試斷言）—— 技能模型這一步的核心驗收
- 達瑞文：Q 強化普攻不吃暴擊也非命中特效，鬼索倍增不划算 → 暴擊＋穿甲
- 凱爾：E 被動是命中特效、11 級起劍氣 → 鬼索首件、命中特效流
- 煞蜜拉：R 十發每發可暴擊、Q 吃半額暴傷 → 無盡提前到第 3 件

**2026-09-16 更新（戰鬥模型修正，`2026-09-16-combat-model-corrections-design.md`）**
—— 攻速改乘攻速係數、上限 3.003、雲陶狂箭 Flurry 依冷卻實算、接斧比例 0.75：

```
達瑞文 vs 脆皮：雲陶狂箭 3032 → 狂戰士護脛 3006 → 臨界點 3302 → 蒐集者 6676
                → 無盡之刃 3031 → 狂暴利刃 3097
達瑞文 vs 坦克：破敗 3153 → 狂戰士護脛 3006 → 多明尼克 3036 → 雲陶狂箭 3032
                → 鬼索 3124 → 無盡之刃 3031
凱爾   vs 脆皮：鬼索 3124 → 狂戰士護脛 3006 → 海妖 6672 → 臨界點 3302
                → 雲陶狂箭 3032 → 無盡之刃 3031          （未變）
煞蜜拉 vs 脆皮：雲陶狂箭 3032 → 狂戰士護脛 3006 → 無盡之刃 3031 → 蒐集者 6676
                → 多明尼克 3036 → 破堡者 2520            （未變）
```

- 只有達瑞文變動：打坦克時雲陶狂箭由第 1 件退到第 4 件，開局讓給破敗
  —— Flurry 不再常駐後，攻速堆疊輸給吃當前生命的現血傷害
- 凱爾攻速係數修正（0.667）與上限改為 3.003 皆未改變任何序列
