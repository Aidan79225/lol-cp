...
**其餘 10 種無錨可定價**，介面標示「未定價」，**不當作 0 併入**：

暴擊傷害、固定生命回復、生命偷取、移速%、治療與護盾力量、韌性、緩速抗性、固定魔穿、百分比魔穿、百分比物穿。
...
殞落王者之劍 3200g →  63.3%   殘差 +1175g  （生命偷取未定價 + 強被動）

# CP值（權威法，達瑞文視角 = 純 Marksman 預設、零覆寫）
無盡之刃     3500g → 103.6%   殘差  −125g   未定價 1  遮罩 0   ← 與全域相同
殞落王者之劍 3200g →  63.3%   殘差 +1175g   未定價 1  遮罩 0   ← 與全域相同
...
殞落王者之劍 3200g →  63.3%   殘差 +1175g   未定價 1  遮罩 0
```
